...
use App\Models\ProfessionalCollege as Table;
use Exception;
use App\Http\Requests\ProfessionalCollegeRequests\UpdateProfessionalCollege as UpdateRequest;
use App\Http\Requests\ProfessionalCollegeRequests\AddProfessionalCollege as AddRequest;
use Illuminate\Http\Request;

class ProfessionalCollegeController extends Controller {
  protected $handle_name = "Professional_college";
  protected $handle_name_plural = "Professional_college";
