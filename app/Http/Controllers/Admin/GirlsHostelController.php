...
use App\Models\GirlsHostel as Table;
use Exception;
use App\Http\Requests\GirlsHostelRequests\UpdateGirlsHostel as UpdateRequest;
use App\Http\Requests\GirlsHostelRequests\AddGirlsHostel as AddRequest;
use Illuminate\Http\Request;

class GirlsHostelController extends Controller {
  protected $handle_name = "Girls_Hostel";
  protected $handle_name_plural = "Girls_Hostel";
